...
figure_title <- ggdraw() +
draw_label(label = "Figure S2", x = 0.5, hjust = 0.5, size = 16.0, fontfamily = "Noto Sans", fontface = "bold")

figure_grid <- plot_grid(figure_title, figure, ncol = 1L, rel_heights = c(0.1, 0.9))
ggsave("figure_s2.pdf", figure_grid, width = 12.0, height = 6.0, units = "in", device = cairo_pdf)
