...
figure_title <- ggdraw() +
    draw_label(label = "Figure S6", x = 0.5, hjust = 0.5, size = 20.0, fontfamily = "Noto Sans", fontface = "bold")

figure_grid <- plot_grid(figure_title, figure, ncol = 1L, rel_heights = c(0.05, 1.0))
ggsave("figure_s6.pdf", figure_grid, width = 12.0, height = 12.0, units = "in", device = cairo_pdf)
