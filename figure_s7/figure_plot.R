...
figure_b <- volcano_plot(all_samples_limma_tibble[["LYVE1+ TR macrophages"]], "LYVE1+ TR macrophages")
figure_c <- volcano_plot(all_samples_limma_tibble[["CD16+ monocytes"]], "CD16+ monocytes")

figure <- ggdraw() +
    draw_plot(figure_a, x = 0.19, y = 0.5, width = 0.64, height = 0.5)  +
    draw_plot(figure_b, x = 0.01, y = 0.0, width = 0.49, height = 0.5) +
    draw_plot(figure_c, x = 0.51, y = 0.0, width = 0.49, height = 0.5) +
...
ggsave("figure_s7.pdf", figure_grid, width = 12.0, height = 12.0, units = "in", device = cairo_pdf)
ggsave("figure_s7_notitle.pdf", figure_grid_notitle, width = 12.0, height = 12.0, units = "in", device = cairo_pdf)
